    ...
    public class ApplicationDbContext: DbContext {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity((EntityTypeBuilder<Interviewee> mappings) =>
            {
                ...
                mappings.Property(p => p.Id).IsRequired().HasColumnType("uuid");
                ...
                mappings.Property(p => p.CreatedBy).HasColumnType("uuid");
                mappings.Property(p => p.EmailAddress).HasColumnType("uuid");
                mappings.Property(p => p.LastModifiedAt).HasColumnType("datetime2");
                mappings.Property(p => p.LastModifiedBy).HasColumnType("uuid");
            });
            ...
            modelBuilder.Entity((EntityTypeBuilder<InterviewSchedule> mappings) =>
            {
                ...
                mappings.Property(p => p.Id).IsRequired().HasColumnType("uuid");
                mappings.Property(p => p.Interviewer).HasColumnType("uuid");
                mappings.Property(p => p.Interviewee).HasColumnType("uuid");
                ...
                mappings.Property(p => p.IsDeleted).HasColumnType("bool");
                mappings.Property(p => p.CreatedAt).HasColumnType("datetime2");
                mappings.Property(p => p.CreatedBy).HasColumnType("uuid");
                mappings.Property(p => p.LastModifiedAt).HasColumnType("datetime2");
                mappings.Property(p => p.LastModifiedBy).HasColumnType("uuid");
